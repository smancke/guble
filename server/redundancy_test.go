...
func Test_Subscribe_on_random_node(t *testing.T) {
	...
	node1.GCM.setupRoundTripper(20*time.Millisecond, 10, testutil.SuccessFCMResponse)
	node2.GCM.setupRoundTripper(20*time.Millisecond, 10, testutil.SuccessFCMResponse)
...
func Test_Subscribe_working_After_Node_Restart(t *testing.T) {
	...
	restartedNode1.GCM.setupRoundTripper(20*time.Millisecond, 10, testutil.SuccessFCMResponse)
