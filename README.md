...
|CLI Option|Env Variable|Values|Default|Requires|Description|
|--- |--- |--- |--- |--- |--- |
...
|--kvs|GUBLE_KVS|memory &#124; file &#124; postgres|file|[ storage_path / pg-{*} ]|The storage backend for the key-value store to use|
...
|--ms|GUBLE_MS|memory &#124; file|file|[ storage_path ]|The message storage backend|
...
|CLI Option|Env Variable|Values|Default|Requires|Description|
|--- |--- |--- |--- |--- |--- |
|--apns|GUBLE_APNS|true &#124; false|false|apns-{*}|Enable the APNS module in general as well as the connector to the development endpoint|
...
|CLI Option|Env Variable|Values|Default|Requires|Description|
|--- |--- |--- |--- |--- |--- |
|sms|GUBLE_SMS|true &#124; false|false|sms-{*}|Enable the SMS gateway|
...
|CLI Option|Env Variable|Values|Default|Requires|Description|
|--- |--- |--- |--- |--- |--- |
|--fcm|GUBLE_FCM|true &#124; false|false|fcm-{*}|Enable the Google Firebase Cloud Messaging connector|
